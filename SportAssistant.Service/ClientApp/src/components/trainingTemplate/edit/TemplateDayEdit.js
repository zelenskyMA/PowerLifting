...
class TemplateDayEdit extends Component {
  ...
  /*
    ...
    confirmAsync = () => { this.props.navigate("/editPlanDays"); }
    ...
    render() {
      ...
      return (
        <>
          ...
          <Button color="primary" outline onClick={() => this.props.navigate(`/editPlanExercises/${this.props.params.id}`)}>Назад</Button>
        </>
      );
    }
  */
