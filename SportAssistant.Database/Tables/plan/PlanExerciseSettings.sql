CREATE TABLE [plan].[PlanExerciseSettings]
(
    ...
    FOREIGN KEY ([PercentageId]) REFERENCES [plan].[Percentages] ([Id]),
    FOREIGN KEY ([PlanExerciseId]) REFERENCES [plan].[PlanExercises] ([Id])
)
