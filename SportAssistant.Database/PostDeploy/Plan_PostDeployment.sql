...
-- Старые, не вошедшие в основную классификацию
    ( 42, 1, 52, 'Толчок с плинтов', ''),
    ( 45, 1, 52, 'Толчок из-за головы', ''),
    ( 61, 1, 53, 'Взятие на грудь + толчок', ''),
    ( 65, 1, 53, 'Взятие на грудь + толчок с паузой в подседе', ''),
    ( 26, 1, 51, 'Взятие на грудь от бедра', ''),
    ( 27, 1, 51, 'Взятие на грудь от паха', ''),
    ( 87, 2, 54, 'Жим из-за головы рывковым хватом', ''),
    ( 95, 1, 54, 'Швунг толчковый', '')
