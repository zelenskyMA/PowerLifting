...
IF NOT EXISTS (SELECT * FROM usr.Users WHERE [Id] = 3)
  INSERT INTO usr.Users (Id, Email, Password, Salt, Blocked) VALUES 
  ( 3, 'manager@mail.ru', 'BD-40-DC-2F-2B-E1-A6-EC-E0-27-63-65-BD-0C-E6-AB-57-54-8F-65', '1CCFD3C98A', 0); --password = asdf123

IF NOT EXISTS (SELECT * FROM usr.Users WHERE [Id] = 4)
  INSERT INTO usr.Users (Id, Email, Password, Salt, Blocked) VALUES 
  ( 4, 'orgOwner@mail.ru', 'BD-40-DC-2F-2B-E1-A6-EC-E0-27-63-65-BD-0C-E6-AB-57-54-8F-65', '1CCFD3C98A', 0); --password = asdf123

IF NOT EXISTS (SELECT * FROM usr.Users WHERE [Id] = 5)
  INSERT INTO usr.Users (Id, Email, Password, Salt, Blocked) VALUES 
  ( 5, 'tester@mail.ru', 'BD-40-DC-2F-2B-E1-A6-EC-E0-27-63-65-BD-0C-E6-AB-57-54-8F-65', '1CCFD3C98A', 0); --password = asdf123
...
IF NOT EXISTS (SELECT * FROM usr.UserInfo WHERE [UserId] = 3) INSERT INTO usr.UserInfo (UserId, FirstName, Surname, Patronimic) VALUES ( 3, 'Менеджер', '', '' );
IF NOT EXISTS (SELECT * FROM usr.UserInfo WHERE [UserId] = 4) INSERT INTO usr.UserInfo (UserId, FirstName, Surname, Patronimic) VALUES ( 4, 'ОргРук', '', '' );
IF NOT EXISTS (SELECT * FROM usr.UserInfo WHERE [UserId] = 5) INSERT INTO usr.UserInfo (UserId, FirstName, Surname, Patronimic) VALUES ( 5, 'Тестер', '', '' );
