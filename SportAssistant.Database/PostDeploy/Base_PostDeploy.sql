...
SET IDENTITY_INSERT Dictionaries ON
  ...
  USING (VALUES 
    ...
    ( 12, 3, 'Менеджер', 'Менеджер организации. Управляет группами тренеров и техническими вопросами.'),
    ( 13, 3, 'Руководитель', 'Владелец и руководитель компании, управляющий менеджерами.'),
