...
namespace PowerLifting.Application.Coaching.TrainingRequestCommands
{
    ...
    /// </summary>
    public class TrainingRequestGetForCoachQuery : ICommand<TrainingRequestGetForCoachQuery.Param, List<TrainingRequest>>
    {
        private readonly ITrainingRequestRepository _trainingRequestRepository;
        private readonly IUserProvider _user;
        private readonly IMapper _mapper;

        public TrainingRequestGetForCoachQuery(
